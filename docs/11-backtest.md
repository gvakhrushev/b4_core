...
- **BTC only, short self-funds.** Every vault starts from the same BTC deposit and posts **no
  ...
  USDC and reclassifying it as perp collateral — the routing that [V6-M-2](audits/archive/AUDIT-V6.md) fixed.
...
> ([AUDIT-V7](audits/archive/AUDIT-V7.md)) — no Critical/High, every finding low and NAV-preserving. The
