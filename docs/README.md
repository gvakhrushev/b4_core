...
> [`../REPORT.md`](docs/audits/REGISTRY.md) for exactly what is and is not proven.
...
- [`../REPORT.md`](docs/audits/REGISTRY.md) — the security dossier and full internal audit history
