...
- [`REPORT.md`](docs/audits/REGISTRY.md) — security dossier and internal adversarial audit rounds (an independent external audit and the funded venue gates are still outstanding)
