...
recorded in [`SLITHER.md`](audits/SLITHER.md) and [`REPORT.md`](audits/archive/REPORT.md).
...
independent audit round of their own**. Audit history and disposition are in [`REPORT.md`](audits/archive/REPORT.md).
...
- [`ARCHITECTURE.md`](../ARCHITECTURE.md) · [`INVARIANTS.md`](../INVARIANTS.md) · [`REPORT.md`](audits/archive/REPORT.md) · [`SLITHER.md`](audits/SLITHER.md)
