...
recorded in [`SLITHER.md`](audits/SLITHER.md) and [`docs/audits/REGISTRY.md`](audits/REGISTRY.md).
...
independent audit round of their own**. Audit history and disposition are in [`docs/audits/REGISTRY.md`](audits/REGISTRY.md).
...
- [`ARCHITECTURE.md`](../ARCHITECTURE.md) · [`INVARIANTS.md`](../INVARIANTS.md) · [`docs/audits/REGISTRY.md`](audits/REGISTRY.md) · [`SLITHER.md`](audits/SLITHER.md)
