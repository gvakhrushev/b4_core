...
| **C5** | 2026-07-21 | High | `B4VaultEngine.sol:783` | Fixed | structural leverage shipped as margin control | StructuralSizing.t.sol |
| **C9** | 2026-07-21 | High | `B4VaultOps.sol:89` | Fixed | short side sized off confirmed peaks | StructuralLeverageShort.t.sol |
| **C10** | 2026-07-21 | Medium | `B4Pool.sol:235` | Accepted | backtest anchors unreproducible at decision time (model bound) | BacktestReal.t.sol |
| **C7** | 2026-07-21 | Medium | `B4Vault.sol:130` | Fixed | deposit routing into the strategy leg | V6B_DepositRouting.t.sol |
