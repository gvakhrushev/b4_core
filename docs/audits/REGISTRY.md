...
| **A42** | 2026-08-02 | High | A41's blind read reached the PUBLISHED figures too: the in-progress cycle mark and the final compounded read were both taken on `navWad`, so every product still holding a perp at those instants was understated. Pro 1,311,594× → 1,814,284×, Pro Max 117.0M× → 188.7M×, cycle-4 returns 1.70×/2.52× → 2.35×/4.07×. Mini and B4 unchanged — they hold no perp there | Fixed | mark-to-market at every value read in the benchmark and the population runner | BacktestReal.t.sol |
