...
| **A39** | 2026-08-02 | — | On identical penalty inflows (9,524 folds per product) the leveraged sleeve ends with HALF the peak NAV of the unlevered ones — running the strategy on the penalty did not beat holding it over this history. Recorded as a measured product property, not a defect | Recorded | `docs/07-fee-routing.md` known-limitation section | ClosedPopulation.t.sol |
