...
- [`docs/audits/REGISTRY.md`](docs/audits/REGISTRY.md) — status dossier and internal adversarial-review rounds; an independent external audit is a mandatory unmet release gate · [`SLITHER.md`](audits/SLITHER.md) — static-analysis triage
